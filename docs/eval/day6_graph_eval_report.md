...
| D6-004 | SORT_RULE | /search 的排序规则是什么 | BASELINE | 是 | 是 | 否 | 是 | 是 | source hit; evidence hit; baselineKeywordHitCount=3; graphKeywordHitCount=3; expectedKeywordCount=3; baselineKeywordHitRatio=1.00; graphKeywordHitRatio=1.00 |
